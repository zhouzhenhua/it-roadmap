...
你好，我是大圣，自由职业以后很多同学咨询我学编程路上的困惑，大部分都是方法不得要领，于是我就整理一下自己的知识体系，并且做成可以接受PR的思维导图，先介绍这个图谱的特点和使用方法把
...
第四个就是自己学习是孤独的，我们提供了Gthub Discussions讨论社区，你可以在里面提问，找队友，记录自己的学习，也留下属于你的心路历程
